...
urlpatterns = [
    ...
    path('admin-panel/send-tasks/<int:person_id>/', login_required(views.send_tasks_person), name='send_tasks_person'),
    path('send-tasks/', login_required(views.send_tasks_today), name='send_tasks_today'),
]
